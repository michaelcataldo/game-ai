...
;;
;;  * added contribution from Micha? Marczyk and Don jackson to allow dynamic tracing of fns in a namespace.
;;
...
;;;
(ns ^{:author "Stuart Sierra, Michel Salim, Luc Préfontaine, Jonathan Fischer Friberg, Micha? Marczyk, Don Jackson"
